...
public class CubeSpawner2 : MonoBehaviour
{
    ...
    // Tiempo entre la aparición de cubos (solo necesario si decides tener un tiempo fijo)
    ...
    void Start()
    {
        ...
        // Establecer el tiempo para el primer spawn a 10 segundos después de iniciar
    ...
    void Update()
    {
        ...
        if (Time.time > nextSpawnTime)
        {
            ...
            nextSpawnTime = Time.time + Random.Range(2f, 5f); // Esto hará que los cubos respawneen entre 2 y 5 segundos
